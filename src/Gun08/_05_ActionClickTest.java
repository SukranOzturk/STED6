...
public class _05_ActionClickTest extends BaseDriver {
    ...
    public void Test1() {
        ...
        // kısa hali.
        //aksiyonlar.moveToElement(element).click().build().perform(); // (new Actions(driver) yerine aksiyonlar eklendi, yukarıda
        // tanımlı olduğu için tekrardan tanımlanmayabilir.)
