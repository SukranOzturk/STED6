...
public class _03_ExplicitWait extends BaseDriver {
    ...
    public void Test1()
    {
        ...
        WebDriverWait bekle=new WebDriverWait(driver, Duration.ofSeconds(5)); // 1 kere tanımlanıyor
...
//  34. satırda süreyi az girdiğimizde BaseDriver daki
//driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));  // 20 sn mühlet: elementi bulma mühleti
// komut aktif olunca iki sürenin toplamı kadar süre plmuş oluyor. (Daha önce sorulmuş)